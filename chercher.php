...
$che=$_POST['CheTxt'];
$sql2 = " SELECT * FROM cours where Sujet LIKE '%".$che."%' or Title like '%".$che."%'";
	try {
...
<body>
	...
	<div class="container">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Chercher / <?php echo $che; ?></li>
		</ol>
		...
		<div class="row">			
			...
			<article class="col-md-12 maincontent">
				<header class="page-header">
					<h1 class="page-title">Votre recherche de <?php echo $che; ?></h1>
				</header>				
				 ...
				 <thead>
				  ...
				  <tbody>
					...
					<br><br>
					<a target="_blank"  href="telechargement.php?Lien=<?php echo base64_encode($res['Lien']) ?>&Title=<?php echo ($res['Title']) ?>"
	                class="btn btn-action">  
	               <strong><span>Télécharger</span></strong>            	
                	</a>
					</td></tr>
					<?php
					}
		...
		$('#example').dataTable( {
			...
			"language": {
				  processing:     "Traitement en cours...",
		            ...
		            emptyTable:     "Aucune résultats disponible",
			    "paginate": {
			    	first:      "<<<",
	                previous:   "<",
	                next:       ">",
