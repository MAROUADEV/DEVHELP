...
$sql2 = " SELECT * FROM cours where type='logiciels'";
	try {
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
                    ...
                    <li class="active"><a href="logiciels.php" style="font-size:15px;">Logiciels</a></li>
	...
	$(document).ready(function(){
		...
		$('#example').dataTable( {
			...
			"language": {
		            ...
		            emptyTable:     "Aucun logiciels disponible",
			    "paginate": {
			    	first:      "Premier",
	                previous:   "Précédent",
	                next:       "Suivant",
