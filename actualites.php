				...
				<header class="page-header">
				 ...
				 <thead>
				  ...
				  <tbody>
					...
					<a href="actualite.php?id=<!--?php echo $res['Id_article'] ?>" style="font-size:15px;" >

                                <div class="thumbnail row">
                                
					               <h3> <a href="actualite.php?id=<?php $res['Id_article'] ?>"><?php echo $res['Titre'] ?> </a></h3>
                                  <div class=" col-sm-4 col-md-4">
                                     <?php echo $res['Image'] ?> 
</div>
                                    </a>
                                <div class=" col-sm-4 col-md-4">
                                      <p > <?php echo substr($res['Sous_titre'],0,500); ?>                                          </p>
                                    <a class=" btn btn-action" href="actualite.php?id=<?php echo $res['Id_article'] ?>">Lire la suite</a>
				                </div>
                            </div>
