...
if (isset($_POST['Titre']) && isset($_POST['Contenu'])) {
					...
					$Lien = trim($Lien);
					$Type = trim($Type);
$sql2 = " INSERT INTO `articles` (`Id_article`, `Titre`, `Contenu`, `Date_creation`) VALUES (NULL, '$Titre', '$Contenu',NULL)";
	try {
		...
		<div class="row">
			...
			<article class="col-sm-12 maincontent">
				<header class="page-header">
					<h1 class="page-title">Nouveau article</h1>
				</header>
				...
				<br>
					<form action="" method="post" enctype="multipart/form-data" >
						<div class="row">
							...
							<div class="col-sm-6">
								<input class="form-control" name="Titre" type="text" placeholder="Titre" id="email" required="required">
							</div>
						</div><br>
                        
						<div class="row">
							<div class="col-sm-12">
								<textarea placeholder="Contenu" class="form-control" rows="9" name="Contenu" required="required"></textarea>
							</div>
						</div>
