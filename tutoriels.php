...
$sql2 = " SELECT * FROM cours where type='tuto'";
	try {
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
                    ...
                    <li class="active"><a href="tutoriels.php" style="font-size:15px;">Tutoriels</a></li>
		...
		<div class="row">			
			...
			<article class="col-md-12 maincontent">
				<header class="page-header">
					<h1 class="page-title">Tutoriels</h1>
				</header>				
				 <table class=" display table-striped " id="example">
				 <thead>
					<tr><th></th class="col-md-10"><th></th class="col-md-2"></tr>
				  </thead>
				  <tbody>
					<?php foreach ($results as $res) { ?>
					<tr>
					<td style="background-color:#FFFFFF;" class="col-md-10">
	               ...
	               <strong><span><i class="fa fa-download"></i> Télécharger</span></strong>            	
					...
					<?php
					list($Media, $YT) = preg_split('[;]', $res['Lien']);
					if($YT!=null)
						{
					?> 
					</br></br>
					<a target="_blank"  href="<?php echo ($YT) ?>" class="btn btn-success">  
	               <strong><span><i class="fa fa-play-circle"></i> Voir la vidéo</span></strong>            	
                	</a>
					<?php 
				       	}
				    ?> 
	...
	$(document).ready(function(){
		...
		$('#example').dataTable( {
			...
			"language": {
		            ...
		            emptyTable:     "Aucun tutoriels disponible",
			    "paginate": {
			    	first:      "Premier",
	                previous:   "Précédent",
	                next:       "Suivant",
